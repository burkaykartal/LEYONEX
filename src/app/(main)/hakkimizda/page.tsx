...
export const metadata = {
  title: "Hakkımızda - Luna 360 Expo",
  description: "15+ yıllık deneyim, 500+ başarılı proje, 25+ ülkede fuar organizasyonu. Luna 360 Expo ile tanışın.",
};
					...
					<div className="container mx-auto px-4">
						<div className="max-w-4xl mx-auto">
							<h2 className="text-3xl md:text-4xl font-bold mb-8 text-center">
								Luna 360 Expo Kimdir?
							</h2>
							<div className="space-y-6 text-gray-300 text-lg leading-relaxed">
								<p>
									Luna 360 Expo, 2009 yılından bu yana fuar organizasyonu alanında
