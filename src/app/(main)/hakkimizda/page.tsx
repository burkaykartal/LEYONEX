...
export const metadata = {
  ...
  description: "15+ yıllık deneyim, 100+ başarılı proje, 25+ ülkede fuar organizasyonu. Leyonex ile tanışın.",
};
	...
	return (
		<>
			...
			<main className="min-h-screen pt-20">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
							<Card className="bg-white border-[#eaecf0] p-8">
								<div className="flex items-center gap-3 mb-4">
									...
									<h2 className="text-3xl font-bold text-[#004767]">Misyonumuz</h2>
								</div>
							...
							<Card className="bg-white border-[#eaecf0] p-8">
								<div className="flex items-center gap-3 mb-4">
									...
									<h2 className="text-3xl font-bold text-[#004767]">Vizyonumuz</h2>
								</div>
								<p className="text-[#404D60] text-lg leading-relaxed">
				...
				<section className="py-16 bg-white">
					<div className="container mx-auto px-4">
						<div className="max-w-4xl mx-auto">
							<h2 className="text-3xl md:text-4xl font-bold mb-8 text-center text-[#004767]">
								Leyonex Kimdir?
							</h2>
							<div className="space-y-6 text-[#404D60] text-lg leading-relaxed">
								...
								<p>
									100&apos;den fazla başarılı proje deneyimimiz ve 25&apos;ten fazla ülkedeki işbirliklerimiz
				...
				<section className="py-16 bg-[#F5F7FA]">
					<div className="container mx-auto px-4">
						<h2 className="text-3xl md:text-4xl font-bold mb-12 text-center text-[#004767]">
							Değerlerimiz
						</h2>
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
							{[
								...
								<Card key={index} className="bg-white border-[#eaecf0] p-6 hover:border-accent/50 transition-colors">
									<div className="flex flex-col items-center text-center gap-4">
										<div className="p-3 bg-[#F5F7FA] rounded-full">
											{value.icon}
										</div>
										<h3 className="text-xl font-bold text-[#004767]">{value.title}</h3>
										<p className="text-[#404D60] text-sm">{value.description}</p>
									</div>
								</Card>
							))}
						</div>
						...
						<div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
							{[
								...
								<div key={index} className="text-center">
									...
									<div className="text-[#404D60] text-sm md:text-base">
										{stat.label}
									</div>
								</div>
							))}
